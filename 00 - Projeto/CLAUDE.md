...
**Código:** baseline 6/6 + ferramentas C2.5 (`calibrate`/`altitude`/`heat`) + **`predict_match`** (prever um jogo) + **`web`** (interface gráfica). **83 testes**, pipeline E2E. Modelo `baseline-v0.2.1-altitude`. Ver [[Codigo (estrutura)]] e [[Como rodar o sistema]].
