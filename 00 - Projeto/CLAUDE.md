...
- **Commit-ready:** `git add -A && git commit -m "D-75/76/77: eps_ko=0.049 [medido] + monitor reliability/drift por mercado + odds_close (captura semi-auto do fechamento, CLV) + testes; analise STEP 0"`
