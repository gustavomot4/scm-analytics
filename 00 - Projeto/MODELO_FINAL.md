...
|---|---|---|
| [[Ajustes ambientais]] (altitude, calor, piso de bola parada) | adicionam parâmetros novos; risco de dupla contagem (altitude×mando) e de overfit | C2.5, **um a um atrás do portão** |
